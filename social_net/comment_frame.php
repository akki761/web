...
if (isset($_POST['postComment' . $getid . ''])) {
 ...
 $posted_to = "sinimma";
 $insertPost = mysqli_query($conn,"INSERT INTO post_comments VALUES ('','$post_body','$user','$posted_to','0','$getid')");
...
$get_comments = mysqli_query($conn,"SELECT * FROM post_comments WHERE post_id='$getid' ORDER BY id DESC");
