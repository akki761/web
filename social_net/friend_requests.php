...
if (isset($_POST['acceptrequest'.$user_from])) {
  ...
  $delete_request=mysqli_query($conn,"DELETE FROM friend_requests WHERE user_to='$user_to'&&user_from='$user_from'");
...
$ignore_request = mysqli_query($conn,"DELETE FROM friend_requests WHERE user_to='$user_to'&&user_from='$user_from'");
