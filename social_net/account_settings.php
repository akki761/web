...
<?php
  ...
  if ($updateinfo) {
   ...
   else
   {
    ...
    $info_submit_query = mysqli_query($conn,"UPDATE users SET first_name='$firstname', last_name='$lastname', bio='$bio' WHERE username='$user'");
...
Old Password: <input type="password" id="change" name="oldpassword" id="change" size="40"><br />
New Password: <input type="password" id= "change" name="newpassword" id="change" size="40"><br /> 
Repeat Password  : <input type="password" name="newpassword2" id="change" size="40"><br />
